...
const createUser = async(req,res)=>{
    let {first_name,last_name,dni,email,gender, password} = req.body;
    if(!first_name||!last_name||!dni||!email) return res.status(400).send({status:"error",error:"Incomplete values"})
